...
const Register = () => {
    return (
        <>
        <Helmet>   
            <meta name="description" content="Register for a comunity of people that are passionate about astronomy" />
            ...
            <meta property="og:description" content="Register for a comunity of people that are passionate about astronomy"/>
